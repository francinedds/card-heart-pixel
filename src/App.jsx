      ...
      <div className="w-[420px] border-[3px] border-red-800 shadow-inner rounded-sm">
        <div className="flex items-center justify-between px-3 py-4 bg-gradient-to-r from-red-800 to-red-700 text-white text-s">
          ...
          <div className="flex gap-1">
            <button>
              <img src="src/assets/minimalize.png" alt="minimalize" className="w-[20px]"/>
            </button>
            <button>
              <img src="src/assets/close.png" alt="close" className="w-[20px]"/>
            </button>
          </div>
        </div>
        ...
        <div className="bg-neutral-300 p-5">
          <div className="flex items-center justify-center -mt-4">
            <button onClick={handleClick}><img src="src/assets/fill.png" alt="coração" id='button-heart' className="w-[100px] mx-auto"/></button>
          </div>
          <div className="flex items-center justify-center w-80 h-80 -mt-5 mx-auto">
            <img src={`src/assets/sprite-${index}.png`} alt={`frame ${index}`} className="object-contain max-w-full max-h-full" />
          </div>
